const en = {
  ...
  cdn: {
    ...
    description:
      "Database optimization and cache management for JSONB compression and retention policy enforcement.",
    stats: {
      lz4Columns: "LZ4 Compressed JSONB Columns",
      fetchedAtIndexes: "Fetched At Indexes",
      lastCleanup: "Last Automatic Cleanup",
      noRun: "No run yet",
      rowsDeleted: "{{count}} rows deleted",
    },
    tables: {
      title: "Cache Tables Status",
      columns: {
        table: "Table",
        tier: "Tier",
        rows: "Rows",
    ...
    cleanup: {
      runButton: "Run Manual Cleanup",
      confirmTitle: "Run Cache Cleanup?",
      confirmContent:
        "This will delete expired rows from all cache tables. This operation cannot be undone.",
      success: "Cache cleanup completed successfully",
      resultTitle: "Cleanup Results",
      result: {
        table: "Table",
        tier: "Tier",
