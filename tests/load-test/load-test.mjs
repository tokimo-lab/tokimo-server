...
const ENDPOINTS = [
  ...
  },
  {
    name: "hot.list",
    repeat: [
      "/api/hot/list?id=weibo",
      "/api/hot/list?id=baidu",
      "/api/hot/list?id=bilibili",
      "/api/hot/list?id=github",
      "/api/hot/list?id=hackernews",
      "/api/hot/list?id=v2ex",
      "/api/hot/list?id=toutiao",
      "/api/hot/list?id=36kr",
      "/api/hot/list?id=juejin",
      "/api/hot/list?id=sspai",
      "/api/hot/list?id=zhihu",
      "/api/hot/list?id=douyin",
      "/api/hot/list?id=douban-movie",
      "/api/hot/list?id=thepaper",
      "/api/hot/list?id=hupu",
      "/api/hot/list?id=ithome",
      "/api/hot/list?id=tieba",
      "/api/hot/list?id=netease-news",
    ],
    unique: () => `/api/hot/list?id=${rand()}`,
  },
  {
    name: "itunes.album-cover",
    repeat: [
      "/api/itunes/album-cover?artist=Adele&album=21",
      "/api/itunes/album-cover?artist=Taylor%20Swift&album=1989",
      "/api/itunes/album-cover?artist=Coldplay&album=Parachutes",
    ],
    unique: () =>
      `/api/itunes/album-cover?artist=${rand()}&album=${rand()}`,
  },
  {
